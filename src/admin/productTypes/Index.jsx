                ...
                <tr key={index} className={`hover:bg-gray-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}`}>
                  ...
                  <td className='whitespace-nowrap border-r border-b border-black text-black'>
                    <div className='grid grid-cols-2 text-center gap-2'>
                      <div>
                        <button onClick={() => navigate("/admin/productTypes/" + productTypes.id)} className="p-1 bg-cyan-500 rounded-md hover:bg-cyan-800 text-white">
                      ...
                      <div>
                        <button className="p-1 bg-cyan-500 rounded-md hover:bg-cyan-800 text-white" onClick={() => deleteProductTypes(productTypes.id)}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
