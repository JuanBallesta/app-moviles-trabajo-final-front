                ...
                <tr key={index} className={`hover:bg-gray-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}`}>
                  ...
                  <td className='whitespace-nowrap border-r border-b border-black text-black'>
                    <div className='grid grid-cols-2 text-center gap-2'>
                      <div>
                        <button onClick={() => navigate("/admin/categories/" + categorie.id)} className="text-white p-1 bg-cyan-400 rounded-md transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:bg-cyan-500">
                      ...
                      <div>
                        <button className="text-white p-1 bg-cyan-400 rounded-md transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:bg-cyan-500" onClick={() => deleteCategorie(categorie.id)}>
                          <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24">
