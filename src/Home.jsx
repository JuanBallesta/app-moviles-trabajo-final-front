...
function Home() {
  ...
  const chargeTastes = () => {
    ...
    axios
      .get(
        `/tastes/list?pagina=${pagina}&cantidad=5&filtro=${filtro}&categories=${categorieSelected}&productTypes=${productTypesSelected}`
      )
      .then((respuesta) => {
      ...
      <div className="p-5 bg-cyan-200">
        <div className="content-center">
          <Container
            ...
            setProductTypesSelected={setProductTypesSelected}
          />
